...
* **ADMIN:** Has full access, including deleting records (DELETE).
...
2. Execute the SQL scripts located in `src/main/resources/sql` to create the `clinic_db`, `user`, `role`, and `users_roles` tables.
